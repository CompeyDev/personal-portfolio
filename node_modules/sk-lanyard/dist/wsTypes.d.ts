...
export declare enum LanyardOpcode {
    EVENT = 0,
    HELLO = 1,
    INITIALIZE = 2,
    HEARTBEAT = 3
}
export declare type LanyardEventType = 'INIT_STATE' | 'PRESENCE_UPDATE';
export declare type InitState = LanyardData | Record<string, LanyardData>;
export declare type PresenceUpdate = LanyardData | (LanyardData & {
    user_id: string;
});
export declare type LanyardEvents = {
...
export declare type LanyardInitializeData = LanyardInitializeOne | LanyardInitializeMany | LanyardInitializeAll;
