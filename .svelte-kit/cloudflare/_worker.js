...
// .svelte-kit/output/server/_app/immutable/chunks/index-0da3af2d.js
function run(fn) {
  return fn();
}
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    file = "_app/immutable/pages/__layout.svelte-ffb96357.js";
    imports = ["_app/immutable/pages/__layout.svelte-ffb96357.js", "_app/immutable/chunks/index-01f0dac0.js"];
    stylesheets = ["_app/immutable/assets/__layout-2210303f.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    file2 = "_app/immutable/error.svelte-cd8c9220.js";
    imports2 = ["_app/immutable/error.svelte-cd8c9220.js", "_app/immutable/chunks/index-01f0dac0.js"];
    stylesheets2 = [];
  }
});
...
async function render_response({
  ...
  head += Array.from(stylesheets3).map((dep) => {
    const attributes = [
      'rel="stylesheet"',
      ...
      fetch: async (resource, opts = {}) => {
        ...
        if (is_asset || is_asset_html) {
          ...
          if (options.read) {
            ...
            response = new Response(options.read(file3), {
              headers: type ? { "content-type": type } : {}
            });
          } else {
            response = await fetch(
              `${event.url.origin}/${file3}`,
              opts
            );
          }
...
async function respond$1(opts) {
  ...
  try {
    nodes = await Promise.all(
      route.a.map((n2) => n2 == void 0 ? n2 : options.manifest._.nodes[n2]())
    );
  } catch (err) {
    const error3 = coalesce_to_error(err);
    options.handle_error(error3, event);
...
var template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n\n<head>\n	<meta charset="utf-8" />\n\n	<meta name="viewport" content="width=device-width, initial-scale=1" />\n	<link rel="icon" href="' + assets2 + '/favicon-light.png" id="favicon" />\n	' + head + '\n	<script>\n		const favicon = document.getElementById("favicon");\n		const isDark = window.matchMedia("(prefers-color-scheme: dark)");\n\n		const changeFavicon = () => {\n			if (isDark.matches) favicon.href = "' + assets2 + '/favicon-dark.png";\n			else favicon.href = "' + assets2 + '/favicon-light.png";\n		};\n\n		changeFavicon();\n\n		setInterval(changeFavicon, 1000);\n\n	<\/script>\n</head>\n\n\n<body class="bg-[#525252] dark:bg-[#1f1f1f] motion-safe:transition-colors motion-safe:duration-300">\n	<div>' + body + "</div>\n</body>\n\n</html>";
var read = null;
...
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["CaskaydiaCoveNerdFontCompleteM-.eot", "CaskaydiaCoveNerdFontCompleteM-.ttf", "CaskaydiaCoveNerdFontCompleteM-.woff", "CaskaydiaCoveNerdFontCompleteM-.woff2", "favicon-dark.png", "favicon-light.png", "favicon.png", "robots.txt", "svelte-welcome.png", "svelte-welcome.webp"]),
...
var worker = {
  async fetch(req, env, context) {
    ...
    if (pathname.startsWith(prefix)) {
      ...
      if (manifest.assets.has(file3) || manifest.assets.has(file3 + "/index.html") || prerendered.has(pathname)) {
        res = await env.ASSETS.fetch(req);
      } else {
